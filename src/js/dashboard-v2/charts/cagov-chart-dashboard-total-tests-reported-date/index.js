    ...
    window
      ...
      .then(
        function (alldata) {
          ...
          const repDict = {
            total_tests_performed:this.intFormatter.format(this.chartdata.latest.TOTAL_TESTS_REPORTED_DATE.total_tests_performed),
            new_tests_reported:this.intFormatter.format(Math.abs(this.chartdata.latest.TOTAL_TESTS_REPORTED_DATE.new_tests_reported)),
            new_tests_reported_delta_1_day:this.pctFormatter.format(Math.abs(this.chartdata.latest.TOTAL_TESTS_REPORTED_DATE.new_tests_reported_delta_1_day)),
          };
