...
class CWDSArrowIcon extends window.HTMLElement {
  connectedCallback () {
    ...
    this.innerHTML = `<div class="link-arrow-icon" aria-hidden="true"><svg class="link-arrow-icon-svg" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
