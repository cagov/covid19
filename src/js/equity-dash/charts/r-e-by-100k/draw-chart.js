  ...
  svg
    ...
    .join(enter => {
      enter
        ...
        .attr("x", d => { return 3; })
        .html(d => {
          console.log(d.METRIC_VALUE_PER_100K_CHANGE_30_DAYS_AGO)
          if (!d.METRIC_VALUE_PER_100K_CHANGE_30_DAYS_AGO || Math.abs(d.METRIC_VALUE_PER_100K_CHANGE_30_DAYS_AGO) < 0.0005) {
