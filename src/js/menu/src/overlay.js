import navTemplate from "./overlay-template.js";
  ...
  connectedCallback() {
    ...
    window
      ...
      .then((data) => {
        ...
        this.querySelector(".open-menu").addEventListener(
          "click",
          this.toggleMainMenu.bind(this)
        );
  ...
  expansionListeners() {
    ...
    allMenus.forEach((menu) => {
      ...
      menu.addEventListener("click", function (event) {
        ...
        this.closest(".expanded-menu-col").setAttribute(
          "aria-expanded",
          "true"
        );
        const closestDropDown = this.closest(
          ".expanded-menu-section"
        ).querySelector(".expanded-menu-dropdown");
        if (closestDropDown) {
...
export default CAGOVOverlayNav;
