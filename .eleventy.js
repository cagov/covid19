...
module.exports = function (eleventyConfig) {
  ...
  eleventyConfig.addCollection("translatedposts", function (collection) {
    ...
    collection.getAll().forEach(item => {
      ...
      replaceContent(item, /"https:\/\/covid19.ca.gov\/pdf\//g, `"https://static.covid19.ca.gov/pdf/`);
      replaceContent(item, /"https:\/\/covid19.ca.gov\/img\//g, `"https://static.covid19.ca.gov/img/`);
